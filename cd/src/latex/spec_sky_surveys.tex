...
More reasonable is to display spectra as graphs of intensities of~the~light as the vertical axis and wavelengths as the horizontal axis:
...
\quad
\subfloat[
	The jet of the quasar 3C 273 by \href{https://chandra.harvard.edu/photo/2000/0131/index.html}{NASA/CXC/SAO/H. Marshall et al.}
...
\subfloat[
	...
	Therefore, its distribution of observations is almost uniform on the northern hemisphere.
	An exception is the surroundings of the zenith due to the telescope construction limits.
...
\subfloat[
	...
	its catalogues contain an only small amount of QSOs in comparison to SDSS.
